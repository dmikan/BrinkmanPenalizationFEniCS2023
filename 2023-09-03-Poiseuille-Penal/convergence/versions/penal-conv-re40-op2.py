...
for eta_brinkman in eta_values:
    ...
    error_L2_omega_f_arr = [error ** 2 for error in error_L2_omega_f_arr]
    error_L2_time_omega_f = np.sqrt(dt_samples*np.sum(error_L2_omega_f_arr))
    ...
    norm_L2_omega_s_arr = [error ** 2 for error in norm_L2_omega_s_arr]
    norm_L2_time_omega_s = np.sqrt(dt_samples*np.sum(norm_L2_omega_s_arr))
