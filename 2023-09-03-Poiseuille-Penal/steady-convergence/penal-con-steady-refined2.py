...
V_ref_elem =  dolfin.VectorElement("Lagrange", mesh_ref.ufl_cell(), 2)
Q_ref_elem =  dolfin.FiniteElement("Lagrange", mesh_ref.ufl_cell(), 1)
...
# Define function spaces
V_penal_elem =  dolfin.VectorElement("Lagrange", mesh_penal.ufl_cell(), 2)
Q_penal_elem =  dolfin.FiniteElement("Lagrange", mesh_penal.ufl_cell(), 1)
...
bcp_outflow_ref = dolfin.DirichletBC(W_ref.sub(1), dolfin.Constant(0), "x[0] > 2.0 - DOLFIN_EPS")
...
# Outflow boundary condition for pressure
bcp_outflow_penal = dolfin.DirichletBC(W_penal.sub(1), dolfin.Constant(0), "x[0] > 2.0 - DOLFIN_EPS")
