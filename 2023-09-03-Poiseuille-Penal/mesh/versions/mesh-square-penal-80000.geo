...
Point(9) = {0.5+0.1, 0.5-0.1, 0, 0.5};
Point(10) = {0.5+0.1, 0.5+0.1, 0, 0.5};
Point(11) = {0.5-0.1, 0.5+0.1, 0, 0.5};
Point(12) = {0.5-0.1, 0.5-0.1, 0, 0.5};
...
Characteristic Length {1} = 0.014;
Characteristic Length {2} = 0.014;
Characteristic Length {3} = 0.014;
Characteristic Length {4} = 0.014;
